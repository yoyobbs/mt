                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <a href="{$metron['client_macos']['clash']['down']}" class="btn btn-pill btn-v2ray copy-text">&nbsp;&nbsp;<i class="metron-clash text-white"></i>下载   V2rayU 客户端</a>&nbsp;&nbsp;&nbsp;
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                       ...
                                                       <div class="h6 pt-2">点击上方按<code>复制V2ray订阅</code></div>
                                                        <div class="h6 pt-2">粘贴到软件的<code>订阅设置</code>--<code>URL</code>上，备注随便写，然后先点一下<code>添加</code>，再点<code>更新</code></div>
                                                        <div class="h6 pt-2">选择一条线路，就可以用了</div>
