...
$_MT['agent_menu_enable']   = false;     // 菜单显示 代理中心 (代理中心需额外 Agent 授权, 未购买无法使用);     
...
# 支付宝: idtpay | codepay | idtpay_qr | stripe | paytaro | wolfpay_ur | materialpay | bitpayx | wolfpay_qr | tomatopay | yftpay | pycloudspay | f2fpay | pcexpay
# 微信  : idtpay | codepay | idtpay_qr | stripe | paytaro | wolfpay_ur | materialpay | bitpayx | payjs
# QQ钱包: idtpay | codepay |
# 数字货币: bitpay |
...
/*
    'ssr' => array(
        ...
        'url' => '/user/tutorial?os=Windows&client=SSR',
        'down'  => 'https://www.google.com',
        'vs'  => 'v1.0',
    ),
*/
