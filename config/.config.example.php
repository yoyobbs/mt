...
$_ENV['appName']    = 'panel';                      //站点名称
$_ENV['baseUrl']    = 'https://url.com';               //站点地址
$_ENV['muKey']      = 'mukey';              //用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
...
$_ENV['db_password']  = 'panel';           //用户名对应的密码
#高级
...
//用户注册设置-----------------------------------------------------------------------------------------
$_ENV['reg_auto_reset_day']        = 1;                         //注册时的流量重置日，0为不重置
$_ENV['reg_auto_reset_bandwidth']  = 50;                         //需要重置的流量，0为不重置
...
//支付系统设置----------------------------------------------------------------------------------------
#取值 none | codepay | f2fpay | chenAlipay | paymentwall | spay |tomatopay | payjs | yftpay | flyfoxpay
...
#materialpay设置 https://www.materialpay.com
